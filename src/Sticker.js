      ...
      <div className="mt-20 container mx-auto">
        ...
        <div className="flex flex-wrap -mx-4">
          {produce.includes("chicken") && (
            <div
              style={{ height: "400px" }}
              className="items-stretch w-full mb-24 px-4 md:w-1/3"
            >
            ...
            <div className="rounded overflow-hidden shadow-lg">
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-gray-700 text-lg">
                  Our animals are roaming free. They have enough space and are
                  not locked in cages.
                </p>
              </div>
            </div>
          ...
          <div className="items-stretch w-full mb-24 px-4 md:w-1/3">
            <div className="rounded overflow-hidden shadow-lg">
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-gray-700 text-lg">
                  Our animals do not get any antibiotic injections, while a lot
                  of animals around the world get them.
                </p>
              </div>
            </div>
          </div>
