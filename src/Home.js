      ...
      <div>
        ...
        <div class="flex justify-around mt-8">
          {this.state.pageIndex > 0 ? (
            <button class="text-white bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded"
          ...
          {!stickerManager.isPagePledged(this.state.currentPage) && this.state.currentPage.length === 15 ? (
            <Link to={"goals/" + this.state.pageIndex}>
              <button
                className={"text-white font-bold py-2 px-4 border border-blue-700 rounded " + (isPledged ? "bg-gray-500 hover:bg-gray-700 cursor-not-allowed" : "bg-blue-500 hover:bg-blue-700 text-white ")}
                disabled={isPledged}
              >
          ...
          {this.state.pageIndex < this.state.amountOfPages - 1 ? (
            <button className={"text-white bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded"}
